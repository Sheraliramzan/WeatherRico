  ...
  return (
    <>
      ...
      <main className="flex flex-col justify-between h-screen w-full bg-stone-600">
        ...
        <div className="flex justify-between w-full bg-amber-300 py-4 items-center gap-2 px-14">
          <p className="text-center text-lg text-white justify-center justify-items-center">By - Aly Ramzan</p>
        </div>
      </main>
    </>
  );
